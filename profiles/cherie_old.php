<!-- This is Cherie's Profile -->
	<table cellspacing=0 cellpadding=0 width=100%>
		<tr>
			<td width=100%>
				<div id="bluecontent">
					<h2><name="intro" id="cherie"><font color="#6d0e0e">Principal Investigator</font></h2>

					<h2><img src="grouppictures/cherie2.jpg" alt="Professor Cherie Kagan" class="right" width=300px/>Cherie R. Kagan</h2>
					Stephen J. Angello Professor
					<br /><br />
					<a href="http://www.ese.upenn.edu/" target="_blank" class="para">Department of Electrical and Systems Engineering (ESE) </a>
					<br>

					<a href="http://www.seas.upenn.edu/mse/" target="_blank" class="para">Department of Materials Science and Engineering (MSE)</a>
					<br>

					<a href="http://www.chem.upenn.edu/chem/" target="_blank" class="para">Department of Chemistry</a>
					<br><br>
					276 Levine Hall
					<br>
					Phone:  (215) 573-4384
					...
					(215) 573-2068
					<br>
					<a href="mailto:kagan@seas.upenn.edu">kagan@seas.upenn.edu</a>

					<br> 
					<br>
					<em>Educational Background</em>:
					<br> 
